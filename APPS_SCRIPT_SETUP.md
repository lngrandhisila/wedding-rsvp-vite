# Apps Script Setup for RSVP Count Syncing

The website now fetches RSVP counts from the Google Sheet on page load. You need to update your Apps Script to include a `getRsvpCounts` action.

## Quick Setup

1. Open your Google Apps Script in Google Sheets
2. Copy the updated code from `APPS_SCRIPT_CODE.gs` in this project
3. Replace your entire `doPost` function and add the `getRsvpCounts` function
